...
sections:
  ...
  - block: markdown
    content:
      title: '📚 My Research & Google Scholar Metrics'
      subtitle: ''
      text: |-
        <div style="display:grid; gap:1.5rem; grid-template-columns:repeat(auto-fit,minmax(320px,1fr)); align-items:start; margin-top:0.5rem;">
          <div>
            <h3 style="margin:0 0 0.6rem 0; font-size:1.15rem;">My Research</h3>
          ...
          <div>
            <h3 style="margin:0 0 0.6rem 0; font-size:1.15rem;">Google Scholar Metrics</h3>
            ...
            <p style="margin-top:0.6rem;"><a href="https://scholar.google.com/citations?user=KhaN2PgAAAAJ&hl=zh-CN" target="_blank" rel="noopener noreferrer">View full profile on Google Scholar →</a></p>
          </div>
        </div>
    design:
      columns: '1'
